...
var logger = {
  ...
  keysValues: function keysValues() {
    var _this = this;

    console.log(Object.keys(this).forEach(function (key) {
      console.log("\"".concat(key, "\": ").concat(_this[key]));
    }));
  }
};
...
//# sourceMappingURL=/ninja.e31bb0bc.js.map